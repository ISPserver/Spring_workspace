...
function regist(){
	...
	$.ajax({
		...
		type:"post",
		success:function(responseData){//성공여부 판단할 수 있는 데이터
			var json = JSON.parse(responseData);//string --> json 파싱
			alert(responseData);
		}
	});
}
...
<div class="container">
   <form> 
    ...
    <input type="button" value="상품등록" onClick="location.href='/client/notice/list'">
  </form>
</div>
